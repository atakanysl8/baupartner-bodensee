...
const faqSchema = {
  ...
  mainEntity: [
    ...
    { '@type': 'Question', name: 'Welche Sanitärbetriebe vermitteln Sie?', acceptedAnswer: { '@type': 'Answer', text: 'Wir vermitteln Sanitärbetriebe aus unserem Netzwerk in der Bodenseeregion. Für Installationsarbeiten an wasser- und gasführenden Leitungen gelten die gesetzlichen Vorgaben der Handwerksordnung, die der jeweils ausführende Betrieb einzuhalten hat.' } },
