...
const faqSchema = {
  ...
  mainEntity: [
    ...
    { '@type': 'Question', name: 'Was kostet mich die Vermittlung eines Hochbau-Betriebs?', acceptedAnswer: { '@type': 'Answer', text: 'Unsere Vermittlung ist für Sie vollständig kostenlos und unverbindlich. Wir finanzieren uns über eine Provision der vermittelten Fachbetriebe – Sie zahlen keinen Aufschlag und haben keinerlei Verpflichtung.' } },
  ],
}
